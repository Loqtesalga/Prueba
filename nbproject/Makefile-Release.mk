...
${OBJECTDIR}/Caballo.o: Caballo.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Caballo.o Caballo.cpp

${OBJECTDIR}/Peon.o: Peon.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Peon.o Peon.cpp

${OBJECTDIR}/Piezas.o: Piezas.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Piezas.o Piezas.cpp
...
${OBJECTDIR}/Rey.o: Rey.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Rey.o Rey.cpp
...
${OBJECTDIR}/bmp.o: bmp.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bmp.o bmp.cpp

${OBJECTDIR}/igvCamara.o: igvCamara.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/igvCamara.o igvCamara.cpp

${OBJECTDIR}/igvColor.o: igvColor.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/igvColor.o igvColor.cpp

${OBJECTDIR}/igvEscena3D.o: igvEscena3D.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/igvEscena3D.o igvEscena3D.cpp

${OBJECTDIR}/igvFuenteLuz.o: igvFuenteLuz.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/igvFuenteLuz.o igvFuenteLuz.cpp

${OBJECTDIR}/igvInterfaz.o: igvInterfaz.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/igvInterfaz.o igvInterfaz.cpp

${OBJECTDIR}/igvMallaTriangulos.o: igvMallaTriangulos.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/igvMallaTriangulos.o igvMallaTriangulos.cpp

${OBJECTDIR}/igvMaterial.o: igvMaterial.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/igvMaterial.o igvMaterial.cpp

${OBJECTDIR}/igvPunto3D.o: igvPunto3D.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/igvPunto3D.o igvPunto3D.cpp

${OBJECTDIR}/igvTextura.o: igvTextura.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/igvTextura.o igvTextura.cpp

${OBJECTDIR}/pr4.o: pr4.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pr4.o pr4.cpp
